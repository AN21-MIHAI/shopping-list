...
# Description: builds the list of books that will remain to Ion
# Input: list_carti - the list of books to be processed, 
#        list_brother - list of books that will remain to Ion's brother
#        list_donations - the list of books that will be donated  
# Returns: list_titles_ion - the list of the books that will remain to Ion
def RemainingBooks(list_carti):
    list_titles_ion = []
